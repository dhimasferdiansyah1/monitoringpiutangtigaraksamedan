...
export async function getPemegangDokumenKasir(
  query: string,
  currentPage: number
) {
      ...
      statusserahdokumen: {
        some: {
          OR: [
            {
              status_serah: {
                contains: "Kolektor menyerahkan transfer ke kasir",
              },
            },
            {
              status_serah: {
                contains: "Kasir melakukan penyetoran ke bank",
              },
            },
          ],
        },
...
export async function getPemegangDokumenKasirPages(query: string) {
